...
CREATE TABLE `user` (
  ...
  `username` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '登录账号',
  ...
  UNIQUE KEY `uk_username` (`username`) COMMENT '登录账号唯一索引'
...
INSERT INTO `user` VALUES (1,'zhangsan','123456','张三',100),(2,'lisi','123456','李四',200),(3,'wangwu','123456','王五',150);
...
-- Dump completed on 2026-05-31 17:47:55
